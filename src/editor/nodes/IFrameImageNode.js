...
export default class IFrameImageNode extends EditorNodeMixin(Mesh) {
    static componentName = "iframe";

    static nodeName = "Inline Frame Image";
    ...
    static async deserialize(editor, json, loadAsync, onError) {
        ...
        const { src, projection, controls, alphaMode, alphaCutoff } = json.components.find(c => c.name === "iframe").props;
        ...
        const { href } = json.components.find(c => c.name === "iframe").props;
    ...
    prepareForExport() {
        ...
        if (this.href && this.projection === "flat") {
            this.addGLTFComponent("iframe", { href: this.href });
        }
