...
export default class SnapFrameNode extends EditorNodeMixin(Object3D) {
  ...
  static async deserialize(editor, json) {
    ...
    const snapFrame = json.components.find(c => c.name === "snap-frame");
    node.snapCondition = snapFrame.props.snapCondition;
    node.snapConditionData = snapFrame.props.snapConditionData;
    node.snapAction = snapFrame.props.snapAction;
    node.snapData = snapFrame.props.snapData;
  ...
  prepareForExport() {
    ...
    this.addGLTFComponent("snap-frame", {
      snapCondition: this.snapCondition,
      snapConditionData: this.snapConditionData,
      snapAction: this.snapAction,
      snapData: this.snapData
