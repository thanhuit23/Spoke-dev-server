...
export const scaledThumbnailUrlFor = (url, width, height) => {
  if (configs.RETICULUM_SERVER.includes("meta2.teacherville.co.kr") && url.includes("meta2.teacherville.co.kr")) {
    return url;
  }
...
export default class Project extends EventEmitter {
  ...
  getSceneUrl(sceneId) {
    if (configs.HUBS_SERVER === "meta2.teacherville.co.kr:8080" || configs.HUBS_SERVER === "meta2.teacherville.co.kr:8080") {
