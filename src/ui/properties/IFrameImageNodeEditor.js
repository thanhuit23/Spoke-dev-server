...
export default function IFrameImageNodeEditor(props) {
  ...
  return (
    <NodeEditor description={IFrameImageNodeEditor.description} {...props}>
...
IFrameImageNodeEditor.propTypes = {
  editor: PropTypes.object,
  node: PropTypes.object,
  multiEdit: PropTypes.bool
};

IFrameImageNodeEditor.iconComponent = FilterFrames;

IFrameImageNodeEditor.description = "Dynamically load an image to overlay the entire webpage onto your hub's scene.";