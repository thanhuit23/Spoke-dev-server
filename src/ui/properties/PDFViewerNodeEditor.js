...
export default function PDFViewerNodeEditor(props) {
    ...
    const onChangePDFViewerServer = useSetPropertySelected(editor, "pdfViewerServer");
    const onChangePDFFileUrl = useSetPropertySelected(editor, "pdfFileUrl");
    console.log(editor);
    console.log(node);
    return (
        <NodeEditor description={PDFViewerNodeEditor.description} {...props}>
            ...
            <InputGroup name="Link PDF Viewer Server" info="Server to viewer the pdf file.">
                <StringInput value={node.pdfViewerServer} onChange={onChangePDFViewerServer} />
            </InputGroup>
            <InputGroup name="Link PDF File" info="The pdf file link.">
                <StringInput value={node.pdfFileUrl} onChange={onChangePDFFileUrl} />
            </InputGroup>
...
PDFViewerNodeEditor.propTypes = {
    editor: PropTypes.object,
    node: PropTypes.object,
    multiEdit: PropTypes.bool
};

PDFViewerNodeEditor.iconComponent = FilePdf;

PDFViewerNodeEditor.description = "Dynamically load a PDF viewer to overlay the entire webpage onto your hub's scene.";