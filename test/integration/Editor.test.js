...
test("Editor should load V1TestScene", withPage(`/projects/new?template=${v1TestSceneUrl}`), async (t, page) => {
  ...
  t.is(model1Props.src, "https://143.198.201.239:9090/test-assets/duck.glb");
  ...
  t.is(model2Props.src, "https://143.198.201.239:9090/test-assets/ceiling-fan.glb");
  ...
  t.is(spawnerProps.src, "https://143.198.201.239:9090/test-assets/camera.glb");
  ...
  t.is(image1Props.src, "https://143.198.201.239:9090/test-assets/spoke-logo.png");
  ...
  t.is(image2Props.src, "https://143.198.201.239:9090/test-assets/spoke-logo.png");
  ...
  t.is(video1Props.src, "https://143.198.201.239:9090/test-assets/landing-video.webm");
  ...
  t.is(video2Props.src, "https://143.198.201.239:9090/test-assets/landing-video.webm");
